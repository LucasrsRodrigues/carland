        ...
        >
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            <div className="flex flex-col gap-y-4 font-semibold">
              ...
              <div className="flex items-center gap-x-[10px]">
                <FaEnvelope />
                <div className="font-medium">email@email.com</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <form className="flex gap-x-2 h-14">
              <input className="outline-none bg-white h-full border rounded-lg pl-4 focus:border-accent" type="text" placeholder="Your best email" />

          ...
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none">
              ...
              >
                ...
                Consequuntur eligendi commodi ex officiis ipsa voluptatem
                corporis id dignissimos deserunt praesentium? Repellendus
                laudantium sequi natus et nobis eum saepe error cumque!
              </motion.p>
              <motion.div
